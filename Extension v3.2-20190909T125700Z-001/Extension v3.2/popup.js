document.addEventListener("DOMContentLoaded", function(){  
	...
	// Set not elements. these refer to all but 1 teacher.
	var Nappleby !== document.getElementById("Appleby");
	var NShecalf !== document.getElementById("Shecalf"); 
	var NGraber !== document.getElementById("Graber"); 
	var NHecalf !== document.getElementById("Hecalf");  
	var NPalumbo !== document.getElementById("Palumbo"); 
	var NRauschenberger !== document.getElementById("Rauschenberger"); 
	var NHanna !== document.getElementById("Hanna"); 
	var NPopa !== document.getElementById("Popa"); 
	var NChen !== document.getElementById("Chen"); 
